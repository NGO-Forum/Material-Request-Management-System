  ...
  <v-card elevation="0" class="bg-primary overflow-hidden bubble-shape-sm bubble-primary mb-6">
    <v-card-text class="pa-5">
      <div class="d-flex align-center ga-4">
        ...
        <div>
          <h4 class="text-h4 font-weight-medium">5</h4>
          <span class="text-subtitle-2 text-medium-emphasis text-white">Total Uers</span>
        </div>
      </div>
    </v-card-text>
  </v-card>
  ...
  <v-card elevation="0" class="bubble-shape-sm overflow-hidden bubble-warning">
    <v-card-text class="pa-5">
      <div class="d-flex align-center ga-4">
        ...
        <div>
          <h4 class="text-h4 font-weight-medium">10</h4>
          <span class="text-subtitle-2 text-disabled font-weight-medium">Total Departments</span>
        </div>
      </div>
    </v-card-text>
  </v-card>
